        ...
        <div className="row mt-5">
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12">
            <div className="about-main pt-5 pb-5 text-center">
              {/* <img src={AboutImg} className="about-main-img" /> */}
              ...
              <div className="row">
                ...
                <div className="col-lg-2 col-sm-6 col-xs-6 col-10 text-center m-auto">
                ...
                <div className="col-lg-5">
                  <div className="row mt-5">
                    <div className="col-lg-6 col-sm-6 text-end col-6">
                      <img src={CloudStorage} className="about-img" />
                    </div>
                    <div className="col-lg-6 col-sm-6 text-center col-6">
                      <img src={Computer} className="about-img" />
                    </div>
                  </div>
                  <div className="row mt-5">
                    <div className="col-lg-6 col-sm-6 text-end mt-3 col-6">
                      <img src={Database} className="about-img" />
                    </div>
                    <div className="col-lg-6 col-sm-6 text-center mt-3 col-6">
